...
func (f *sharedInformerFactory) NodeExecs() nodeexec.Interface {
	return nodeexec.New(&factoryAdapter{f})
}
...
// GetInformer 实现 nodeexec.SharedInformerFactory 接口
func (a *factoryAdapter) GetInformer(namespace, kind string) nodeexec.SharedInformer {
	return &informerAdapter{a.factory.GetInformer(namespace, kind)}
}
...
// AddEventHandler 实现 nodeexec.SharedInformer 接口
func (a *informerAdapter) AddEventHandler(handler nodeexec.ResourceEventHandler) {
	a.informer.AddEventHandler(handler)
}

// Run 实现 nodeexec.SharedInformer 接口
func (a *informerAdapter) Run(ctx context.Context) error {
	return a.informer.Run(ctx)
}

// HasSynced 实现 nodeexec.SharedInformer 接口
func (a *informerAdapter) HasSynced() bool {
	return a.informer.HasSynced()
}

// GetStore 实现 nodeexec.SharedInformer 接口
func (a *informerAdapter) GetStore() cache.Store {
	return a.informer.GetStore()
}
